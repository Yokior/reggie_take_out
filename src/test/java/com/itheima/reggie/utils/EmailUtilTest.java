...
public class EmailUtilTest
{
    ...
    public void sendAuthCodeEmail()
    {
        ...
        try
        {
            ...
            mail.setAuthentication("180946064@qq.com", "ycunijewndwncbai");//第一个参数是对应的邮箱用户名一般就是自己的邮箱第二个参数就是SMTP的密码,我们上面获取过了
            mail.setFrom("180946064@qq.com", "lalala");  //发送邮件的邮箱和发件人
